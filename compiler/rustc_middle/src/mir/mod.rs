...
pub struct Body<'tcx> {
    ...
    /// Stores the body of the function generated by the generic trampoline optimisation.
    generic_trampoline_impl_body: Option<Box<Body<'tcx>>>,
...
impl<'tcx> Body<'tcx> {
    pub fn new(
        ...
        let mut body = Body {
            ...
            generic_trampoline_impl_body: None,
        };
